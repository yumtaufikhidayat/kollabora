...
<body>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
    <h5 class="sub-header"><center>Edit Member Proyek Buku Kolaborasi LibreOffice Writer</center></h5>
      <br>
      <br>
        <div class="table-responsive">
          ...
          <div class="rifqi">
            ...
            <a href="#"><button type="button" class="btn btn-default navbar-btn">Hapus</button></a>
          </div>
          <br>
          <br>
            <br>
            ...
            while ($tampil=mysql_fetch_array($sql)){
              ?>
                ...
                <form action="tampil-edit-member.php" method="post">
                  ...
                  <td><?php echo $tampil['aksi']; ?></td>
                  <input type="hidden" name="id" value="<?php echo $id;?>" >
                  <td><button type="submit" class="btn btn-default navbar-btn">Sunting</button></td>
                </form>
                </tr>
          <?php } ?>                  
